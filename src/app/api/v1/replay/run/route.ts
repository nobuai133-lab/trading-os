...
export async function POST(req: Request): Promise<NextResponse> {
  ...
  try {
    const body = await req.json() as ReplayRunRequest;
    ...
    const result = replayService.runSession(body);
    return NextResponse.json(
