...
export async function POST(req: Request): Promise<NextResponse> {
  ...
  try {
    const body = await req.json() as ReplayPauseRequest;
    ...
    const result = replayService.pauseSession(body.replayId);
    return NextResponse.json(
